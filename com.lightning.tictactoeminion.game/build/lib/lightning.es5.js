...
(function (global, factory) {
  ...
  function () {
    ...
    _createClass(TextTextureRenderer, [{
      ...
      value: function _calculateRenderInfo() {
        ...
        var letterSpacing = this._settings.letterSpacing || 0; // Set font properties.
        ...
        if (this._settings.maxLines && lines.length > this._settings.maxLines) {
          ...
          if (this._settings.maxLinesSuffix) {
            ...
            var al = this.wrapText(usedLines[usedLines.length - 1], wordWrapWidth - _w, letterSpacing);
        ...
        for (var _i3 = 0; _i3 < lines.length; _i3++) {
          var lineWidth = this.measureText(lines[_i3], letterSpacing);
      ...
      value: function _draw() {
        ...
        var precision = this.getPrecision(); // Add extra margin to prevent issue with clipped text when scaling.

        this._canvas.width = Math.ceil(renderInfo.width + this._stage.getOption('textRenderIssueMargin'));
        this._canvas.height = Math.ceil(renderInfo.height); // Canvas context has been reset.
        ...
        for (var i = 0, n = renderInfo.lines.length; i < n; i++) {
          linePositionX = 0; // By default, text is aligned to top
  ...
  function () {
    ...
    _createClass(Element, [{
      ...
      value: function getProperties(element) {
        ...
        return _objectSpread2({}, props, {}, element.getNonDefaults());
      }
    }]);
        ...
        descriptors.forEach(function (descriptor) {
          ...
          if (descriptor) {
            ...
            if (type && type !== descType) {
              console.warn("Member ".concat(member, " in ").concat(this._type.name, " has inconsistent types."));
              return;
            }
  ...
  function (_WebGLShader) {
    ...
    function SparkShader() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(SparkShader).apply(this, arguments));
    }
  ...
  function (_WebGLRenderer) {
    ...
    function SparkRenderer(stage) {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(SparkRenderer).call(this, stage));
    }
    ...
    _createClass(WebPlatform, [{
      ...
      value: function loadSrcTexture(_ref, cb) {
        ...
        if (this._imageWorker) {
          ...
          var _image = new Image(); // On the PS4 platform setting the `crossOrigin` attribute on
    ...
    _createClass(Stage, [{
      ...
      value: function gc(aggressive) {
        if (this._lastGcFrame !== this.frameCounter) {
          ...
          console.log("GC".concat(aggressive ? "[aggressive]" : "", "! Frame ").concat(this._lastGcFrame, " Freed ").concat(((memoryUsageBefore - this._usedMemory) / 1e6).toFixed(2), "MP from GPU memory. Remaining: ").concat((this._usedMemory / 1e6).toFixed(2), "MP"));
          var other = this._usedMemory - this.textureManager.usedMemory - this.ctx.usedMemory;
          console.log(" Textures: ".concat((this.textureManager.usedMemory / 1e6).toFixed(2), "MP, Render Textures: ").concat((this.ctx.usedMemory / 1e6).toFixed(2), "MP, Renderer caches: ").concat((other / 1e6).toFixed(2), "MP"));
        }
      }
    }, {
      key: "gcTextureMemory",
      ...
      value: function _receiveKeydown(e) {
        ...
        if (keys) {
          for (var i = 0, n = keys.length; i < n; i++) {
            var hasTimer = this.__keypressTimers.has(keys[i]); // prevent event from getting fired when the timeout is still active
        ...
        if (keys) {
          for (var _i6 = 0, _n4 = keys.length; _i6 < _n4; _i6++) {
            if (this.__keypressTimers.has(keys[_i6])) {
              ...
              clearTimeout(this.__keypressTimers.get(keys[_i6])); // delete so we can register it again
    ...
    _createClass(Tools, null, [{
      ...
      value: function createSvg(cb, stage, url, w, h) {
        ...
        img.onError = function (err) {
          ...
          cb(err);
        }.bind(this); // On the PS4 platform setting the `crossOrigin` attribute on images
  ...
  function (_DefaultShader) {
    ...
    function VignetteShader(context) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(VignetteShader).call(this, context));
  ...
  function (_DefaultShader) {
    ...
    function SpinnerShader(ctx) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(SpinnerShader).call(this, ctx));
      _this._radius = 100;
      _this._width = 50;
      _this._period = 1;
      _this._angle = 0.5;
  ...
  function (_DefaultShader) {
    ...
    function HoleShader(context) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(HoleShader).call(this, context));
      _this._x = 0;
      _this._y = 0;
      _this._w = 0;
      _this._h = 0;
  ...
  function (_DefaultShader) {
    ...
    function PerspectiveShader(ctx) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(PerspectiveShader).call(this, ctx));
      _this._fudge = 0.2;
      _this._rx = 0;
      _this._ry = 0;
      _this._z = 1.0;
