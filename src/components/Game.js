...
export default class Game extends lng.Component {
  static _template() {
    return {
      Game: {
        PlayerPosition: {
        ...
        ScoreBoard: { x: 100, y: 170,
          ...
          Ai: { y: 40,
            text: { text: 'Evil Minion : 0', fontSize: 29 }
          }
        }
      },
      Notification: {
        x: 400, y: 170, text: { fontSize: 70 }, alpha: 0
      }
    };
  }
            ...
            class Winner extends this {
              $enter(args, { winner }) {
                ...
                this.patch({
                  ...
                  Notification: {
                    text: { text: `${winner === IMAGES.GOODMINION ? 'Minion' : 'Evil Minion'} wins !!!!! \n(press enter to continue)` },
                    smooth: { alpha: 1 }
                  }
                });
              }
